...
Give a checklist of all the places modifications had to be made and a one sentence brief of what each of those modifications were in an ordered list of the correct order to implement for: adding a new mark type to pdf.

...
export function MarkSelector({ uiState, uiController }: MarkSelectorProps) {
  ...
  const handleSelectFile = async (filePath: string, name: string) => {
    ...
    uiController.setMarkSelectorOpen(false);
  };
  ...
  return (
    <CenterScreenPanel
      title="Select Content for Mark/Link"
      onCancel={handleCancel}
      onConfirm={handleCancel}
      confirmLabel="Done Browsing"
    >
